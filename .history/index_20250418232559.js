...
console.log(canSignUp("tommola.oke@gmail.com", "")); // Example usage
// console.log(canSignUp("", "")); // comment Example for Cannot sign up
// console.log(canSignUp("", "08012345678")); // comment Example for Can sign up
...
console.log(validateCredentials("JohnDoe", "")); // Example usage for Invalid input
// console.log(validateCredentials("", "password123")); // comment Example for Invalid input
// console.log(validateCredentials("tomolaoke", "password123")); // comment Example for Valid input
