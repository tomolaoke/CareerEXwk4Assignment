...
function checkScore(score) {
    // Logs "Passed" if score is 180 or above, otherwise "Failed"
    if (score >= 180) {
...
// checkScore(120); // Example: Input Score here to get output


// 2. Function to check eligibility to voting
function checkVotingEligibility(age) {
    // Returns appropriate message based on the age
    if (age >= 18) {
...
// console.log(checkVotingEligibility(16)); // Example: For Not Eligible output
...
console.log(evaluateScore("John", 85)); // Example usage
